...
public final class AssetManager implements AutoCloseable {
    ...
    private static final String LOS_APK_PATH = "/system/framework/org.los.platform-res.apk";
    ...
    public static void createSystemAssetsInZygoteLocked(boolean reinitialize,
        ...
        try {
            ...
            apkAssets.add(ApkAssets.loadFromPath(LOS_APK_PATH, ApkAssets.PROPERTY_SYSTEM));
